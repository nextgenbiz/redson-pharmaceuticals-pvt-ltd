              ...
              <div className="pt-2">
                <div className="flex flex-col gap-4">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.97 }}
                    type="submit"
                    className="group flex flex-1 items-center justify-center gap-2 rounded-2xl bg-black px-6 py-4 text-sm font-semibold text-white shadow-md transition-all duration-300 hover:shadow-lg"
                  >
