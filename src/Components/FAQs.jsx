...
export default function FAQs() {
  ...
  return (
    <section
      id="faqs"
      className="relative overflow-hidden bg-white py-12 pb-20"
    >
      <div className="relative mx-auto max-w-[1400px] px-6 lg:px-10">
        <div className="grid gap-14 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          >
            <div>
              ...
              <motion.p
                variants={fadeUp}
                custom={3}
                className="mt-5 max-w-md text-slate-600 leading-relaxed"
              >
            ...
            <motion.div
              variants={fadeUp}
              custom={4}
              className="mt-10 rounded-[24px] border border-[var(--primary)]/40 bg-[var(--primary)]/5 p-6"
            >
              ...
              <div className="mt-5 space-y-4">
                {[
                  ["Dosage Forms", "Multiple Categories"],
                  ["Quality Systems", "QA / QC Integrated"],
                  ["Export Support", "Global Ready"],
                ].map((item, index) => (
                  <motion.div
                    key={index}
                    whileHover={{ x: 6 }}
                    className={`flex items-center justify-between ${
                      index !== 2
                        ? "border-b border-[var(--primary)]/40 pb-4"
                        : ""
                    }`}
                  >
          ...
          <motion.div
            ...
            className="divide-y divide-[var(--primary)]/40 rounded-[28px] border border-[var(--primary)]/40 bg-[var(--primary)]/5 overflow-hidden"
          >
            {faqs.map((faq, index) => {
                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className="flex h-10 w-10 items-center justify-center rounded-xl bg-white border border-slate-200"
                    >
                      {isActive ? (
                        <Minus
                          size={18}
